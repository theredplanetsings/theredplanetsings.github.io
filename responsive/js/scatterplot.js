class Scatterplot {
  ...
  updateVis() {
    ...
    // Update axis groups position based on the computed height
    vis.xAxisG
    ...
    vis.xAxis.tickSize(-vis.config.height - 10);
    vis.yAxis.tickSize(-vis.config.width - 10);

    // Set specific accessor functions
